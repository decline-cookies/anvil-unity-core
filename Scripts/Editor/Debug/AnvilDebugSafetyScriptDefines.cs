...
namespace Anvil.Unity.Editor.Debug
{
    ...
    public static class AnvilDebugSafetyScriptDefines
    {
        ...
        private static readonly ScriptDefineDefinition ANVIL_DEBUG_SAFETY_DEFINITION = new ScriptDefineDefinition(
            ANVIL_DEBUG_SAFETY,
            ANVIL_DEBUG_SAFETY_MENU_PATH,
            null,
            new[] { ANVIL_DEBUG_SAFETY_EXPENSIVE });
        ...
        private static readonly ScriptDefineDefinition ANVIL_DEBUG_SAFETY_EXPENSIVE_DEFINITION = new ScriptDefineDefinition(
            ANVIL_DEBUG_SAFETY_EXPENSIVE,
            ANVIL_DEBUG_SAFETY_EXPENSIVE_MENU_PATH,
            new[] { ANVIL_DEBUG_SAFETY },
            null);
